...
export const PLAN = [
  ...
  // ── WEEK 4: New schedule begins — Run Wed/Fri/Sun + Cycling intro ──
  { week: 4, phase: "Base Building", runs: [
    { day: "Mon", type: "cycle",    title: "Easy Ride",  distance: 12, notes: "First structured ride. Easy effort, 14–16 km/h. Get comfortable on the bike." },
    { day: "Wed", type: "interval", title: "Intervals",  distance: 7,  notes: "5×800m at 5:45/km, 2 min rest between each rep." },
    { day: "Fri", type: "easy",     title: "Easy Run",   distance: 5,  notes: "Easy run. Legs may feel the combo — that's normal." },
    { day: "Sat", type: "cycle",    title: "Longer Ride", distance: 16, notes: "Build to 16km ride. Easy pace. Practice your commute route if possible." },
    { day: "Sun", type: "long",     title: "Long Run",   distance: 14, notes: "First bigger long run. Trust the training." },
  ]},

  // ── WEEK 5: Commute begins + running continues ──
  { week: 5, phase: "Base Building", runs: [
    { day: "Mon", type: "commute", title: "🚲 Commute to Work", distance: 21, notes: "First commute ride — 13 miles in. Moderate pace, arrive composed. Pack change of clothes + food." },
    { day: "Wed", type: "tempo",   title: "Tempo Run",   distance: 8,  notes: "2km warm-up, 4km tempo (6:10/km), 2km cool-down." },
    { day: "Thu", type: "commute", title: "🚲 Commute Home", distance: 21, notes: "Evening ride home. 42km total today with morning ride. No running today." },
    { day: "Fri", type: "easy",    title: "Easy Run",   distance: 5,  notes: "Easy run after commute day. Keep it very relaxed — legs will be tired." },
    { day: "Sun", type: "long",    title: "Long Run",   distance: 15, notes: "Stay patient. Fuel and hydrate well. Legs carry more load now." },
  ]},

  // ── WEEK 6: CUTBACK — running + 1 commute ──
  { week: 6, phase: "Base Building", runs: [
    { day: "Mon", type: "commute", title: "🚲 Commute to Work", distance: 21, notes: "CUTBACK WEEK — commute only, no extra rides. Let body absorb 5 weeks." },
    { day: "Wed", type: "easy",    title: "Easy Run",   distance: 6,  notes: "CUTBACK — easy effort only." },
    { day: "Thu", type: "commute", title: "🚲 Commute Home", distance: 21, notes: "Evening ride home. Easy pace." },
  ...
  { week: 7, phase: "Build", runs: [
    { day: "Mon", type: "commute",   title: "🚲 Commute to Work", distance: 21, notes: "Moderate commute pace — aim for 16–18 km/h. Arrive composed." },
    { day: "Wed", type: "interval",  title: "Intervals",  distance: 8,  notes: "6×800m at 5:45/km, 90s rest between each rep." },
    { day: "Thu", type: "commute",   title: "🚲 Commute Home", distance: 21, notes: "Evening ride home. Easy pace after intervals yesterday." },
    { day: "Fri", type: "easy",      title: "Easy Run",   distance: 6,  notes: "Easy run. Legs carry commute + interval load — stay relaxed." },
    { day: "Sun", type: "long",      title: "Long Run",   distance: 16, notes: "First 16km. Settle into long-run mode. Fuel well." },
  ]},
  { week: 8, phase: "Build", runs: [
    { day: "Mon", type: "commute",  title: "🚲 Commute to Work", distance: 21, notes: "Moderate commute. Your legs are building serious endurance capacity." },
    { day: "Wed", type: "tempo",    title: "Tempo Run",  distance: 9,  notes: "2km warm-up, 5km at tempo (6:05/km), 2km cool-down." },
    { day: "Thu", type: "commute",  title: "🚲 Commute Home", distance: 21, notes: "Evening ride home." },
    { day: "Fri", type: "easy",     title: "Easy Run",   distance: 6,  notes: "Easy recovery run after tempo day." },
  ...
  { week: 9, phase: "Build", runs: [
    { day: "Mon", type: "commute",  title: "🚲 Commute to Work", distance: 21, notes: "Steady commute. You're building serious multi-sport endurance." },
    { day: "Wed", type: "interval", title: "Intervals",  distance: 9,  notes: "4×1km at 5:45/km, 2 min rest between each rep." },
    { day: "Thu", type: "commute",  title: "🚲 Commute Home", distance: 21, notes: "Evening ride home. Easy pace after intervals." },
    { day: "Fri", type: "easy",     title: "Easy Run",   distance: 6,  notes: "Easy recovery. Don't rush after a heavy week." },
    { day: "Sun", type: "long",     title: "Long Run",   distance: 19, notes: "Stay steady. Fuel every 45 mins. Respect the combined load." },
  ]},

  // ── WEEK 10: CUTBACK ──
  { week: 10, phase: "Build", runs: [
    { day: "Mon", type: "commute",  title: "🚲 Commute to Work", distance: 21, notes: "CUTBACK WEEK — commute only this week. No extra rides." },
    { day: "Wed", type: "easy",     title: "Easy Run",   distance: 6,  notes: "CUTBACK — light effort only." },
    { day: "Thu", type: "commute",  title: "🚲 Commute Home", distance: 21, notes: "Easy ride home." },
    { day: "Fri", type: "easy",     title: "Easy Run",   distance: 5,  notes: "Shakeout run." },
    { day: "Sun", type: "long",     title: "Long Run",   distance: 14, notes: "CUTBACK — reduced long run. Let the body absorb training." },
  ]},

  { week: 11, phase: "Build", runs: [
    { day: "Mon", type: "commute",   title: "🚲 Commute to Work", distance: 21, notes: "Back into it feeling fresh. Push the pace slightly — 17–19 km/h." },
    { day: "Wed", type: "tempo",     title: "Tempo Run",  distance: 10, notes: "2km warm-up, 6km tempo (6:00/km), 2km cool-down." },
    { day: "Thu", type: "commute",   title: "🚲 Commute Home", distance: 21, notes: "Evening ride." },
    { day: "Fri", type: "easy",      title: "Easy Run",   distance: 6,  notes: "Easy recovery run." },
    { day: "Sun", type: "long",      title: "Long Run",   distance: 21, notes: "🎉 HALF MARATHON! Your biggest milestone yet." },
  ]},
  { week: 12, phase: "Build", runs: [
    { day: "Mon", type: "commute",   title: "🚲 Commute to Work", distance: 21, notes: "Comfortable after the 21km milestone. Steady commute." },
    { day: "Wed", type: "interval",  title: "Intervals",  distance: 10, notes: "5×1km at 5:40/km, 90s rest between each rep." },
    { day: "Thu", type: "commute",   title: "🚲 Commute Home", distance: 21, notes: "Easy ride home after intervals." },
  ...
  { week: 13, phase: "Build", runs: [
    { day: "Mon", type: "commute",   title: "🚲 Commute to Work", distance: 21, notes: "Final build week. Strong commute — you're fit now." },
    { day: "Wed", type: "tempo",     title: "Tempo Run",  distance: 11, notes: "2km warm-up, 7km at tempo (5:55/km), 2km cool-down." },
    { day: "Thu", type: "commute",   title: "🚲 Commute Home", distance: 21, notes: "Evening ride. Easy after the big tempo." },
    { day: "Fri", type: "easy",      title: "Easy Run",   distance: 7,  notes: "Easy aerobic run." },
    { day: "Sun", type: "long",      title: "Long Run",   distance: 23, notes: "Longest build run. Respect the distance." },
  ]},

  // ── PHASE 3: PEAK (Weeks 14–17) ──
  // Week 14: CUTBACK before peak
  { week: 14, phase: "Peak", runs: [
    { day: "Mon", type: "commute",  title: "🚲 Commute to Work", distance: 21, notes: "CUTBACK WEEK — commute only. No extra rides. Rest before peak phase." },
    { day: "Wed", type: "easy",     title: "Easy Run",   distance: 7,  notes: "CUTBACK — light effort." },
    { day: "Thu", type: "commute",  title: "🚲 Commute Home", distance: 21, notes: "Easy ride home." },
    { day: "Fri", type: "easy",     title: "Easy Run",   distance: 5,  notes: "Very easy. Feel the freshness return." },
    { day: "Sun", type: "long",     title: "Long Run",   distance: 16, notes: "CUTBACK — reduced long run. Legs feel fresher." },
  ]},
  { week: 15, phase: "Peak", runs: [
    { day: "Mon", type: "commute",   title: "🚲 Commute to Work", distance: 21, notes: "Peak phase begins. Strong commute — you're at your fittest." },
    { day: "Wed", type: "interval",  title: "Intervals",  distance: 11, notes: "4×1.5km at 5:50/km, 2 min rest between each rep." },
    { day: "Thu", type: "commute",   title: "🚲 Commute Home", distance: 21, notes: "Easy ride home after big interval session." },
    { day: "Fri", type: "easy",      title: "Easy Run",   distance: 7,  notes: "Easy recovery run." },
    { day: "Sun", type: "long",      title: "Long Run",   distance: 25, notes: "Trust the process. Walk breaks OK. Fuel every 45 min." },
  ]},
  { week: 16, phase: "Peak", runs: [
    { day: "Mon", type: "commute",   title: "🚲 Commute to Work", distance: 21, notes: "Building to peak long run this week. Steady commute." },
    { day: "Wed", type: "tempo",     title: "Tempo Run",  distance: 11, notes: "2km warm-up, 7km at tempo (5:55/km), 2km cool-down." },
    { day: "Thu", type: "commute",   title: "🚲 Commute Home", distance: 21, notes: "Easy ride home." },
    { day: "Fri", type: "easy",      title: "Easy Run",   distance: 7,  notes: "Easy aerobic run." },
  ...
  { week: 17, phase: "Peak", runs: [
    { day: "Mon", type: "cycle",    title: "Easy Recovery Ride", distance: 15, notes: "EASY recovery ride only — not commute. Legs are tired after 28km. Low intensity spin." },
    { day: "Wed", type: "interval", title: "Intervals",   distance: 10, notes: "4×1.5km at 5:50/km, 2 min rest between each rep." },
    { day: "Thu", type: "cycle",    title: "Easy Ride",   distance: 15, notes: "Easy ride. Keep it light — saving legs for Sunday." },
    { day: "Fri", type: "easy",     title: "Easy Run",    distance: 7,  notes: "Easy and relaxed." },
    { day: "Sun", type: "long",     title: "Long Run",    distance: 26, notes: "Last big long run. Easy — save legs for taper." },
  ]},

  // ── PHASE 4: TAPER (Weeks 18–19) ──
  { week: 18, phase: "Taper", runs: [
    { day: "Mon", type: "cycle",   title: "Easy Ride",   distance: 12, notes: "TAPER BEGINS — easy spin only. Volume dropping significantly." },
  ...
  { week: 19, phase: "Taper", runs: [
    { day: "Mon", type: "cycle",    title: "Easy Spin",   distance: 10, notes: "Very easy spin — just keeping legs loose. Race week approaching." },
    ...
    { day: "Sun", type: "long",     title: "Long Run",   distance: 14, notes: "Easy, confidence-building. Enjoy feeling good!" },
  ]},
  ...
  { week: 20, phase: "Race Week 🏁", runs: [
    ...
    { day: "Fri", type: "rest",  title: "Rest Day",      distance: 0,  notes: "Full rest. Sleep early. Carb-load dinner tonight. NO cycling." },
    { day: "Sun", type: "long",  title: "🏆 MARATHON DAY", distance: 42.2, notes: "GO TIME. Start at 8:15/km. Run your own race. Every training run led to this." },
  ]},
];